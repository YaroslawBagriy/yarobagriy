...
const Newsletter = () => {
  ...
  return (
    <div className="container py-12 lg:py-16">
      ...
      <p className="text-3l text-l text-gray-700 leading-relaxed tracking-tight p-6 font-body">
      ...
      <form className="mt-8 sm:flex md:justify-center" onSubmit={handleSubmit}>
        <input
